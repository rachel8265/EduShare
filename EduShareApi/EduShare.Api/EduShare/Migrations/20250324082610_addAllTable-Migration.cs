...
{
    /// <inheritdoc />
    public partial class addAllTableMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RolePermissionsId1 = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PermissionRole", x => new { x.RolePermissionsId, x.RolePermissionsId1 });
                    table.ForeignKey(
                        name: "FK_PermissionRole_Permission_RolePermissionsId1",
                        column: x => x.RolePermissionsId1,
                        principalTable: "Permission",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PermissionRole_Role_RolePermissionsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PermissionRole_RolePermissionsId1",
                table: "PermissionRole",
                column: "RolePermissionsId1");
