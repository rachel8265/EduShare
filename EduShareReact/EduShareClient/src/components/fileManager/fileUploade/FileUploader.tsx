...
// const FileUploader: React.FC<FileUploaderProps> = ({ folderId }) => {
...
//   const userId = user.id // השתמש במזהה המשתמש המחובר
...
//               // disabled={uploadStatus === "uploading" || isUploading || !userId}
//               disabled={uploadStatus === "uploading"  || !userId}
